  ...
  return (
    <>
      ...
      <div className="bg-main h-[5rem] pl-[5.8rem] pt-[5rem] pb-[4.5rem]">
        <p
          className={`bg-gray rounded-lg px-2 py-1 text-[0.9rem] font-bold inline-block mx-2 cursor-pointer ${
            selectedTag === "All"
      ...
      <div className="bg-main pb-[3rem] pl-[6.5rem] pr-0 flex flex-wrap gap-4">
        {data.map((item, id) => (
